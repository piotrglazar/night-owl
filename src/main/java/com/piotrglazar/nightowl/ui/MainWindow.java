...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        mainPanel.add(cityName, new GridConstraints(1, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(161, 16), null, 0, false));
        cityLatitude = new JLabel();
        cityLatitude.setText("Latitude: ");
        mainPanel.add(cityLatitude, new GridConstraints(1, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(239, 16), null, 0, false));
        cityLongitude = new JLabel();
        cityLongitude.setText("Longitude:");
        mainPanel.add(cityLongitude, new GridConstraints(1, 2, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(185, 16), null, 0, false));
        stars = new JLabel();
        stars.setText("stars: 0");
        mainPanel.add(stars, new GridConstraints(4, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(161, 16), null, 0, false));
        userLocations = new JLabel();
        userLocations.setText("userLocations: 0");
        mainPanel.add(userLocations, new GridConstraints(4, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(239, 16), null, 0, false));
        starsAlwaysVisible = new JLabel();
        starsAlwaysVisible.setText("stars always visible: 0");
        mainPanel.add(starsAlwaysVisible, new GridConstraints(5, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(161, 16), null, 0, false));
        starsSometimesVisible = new JLabel();
        starsSometimesVisible.setText("stars sometimes visible: 0");
        mainPanel.add(starsSometimesVisible, new GridConstraints(5, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(239, 16), null, 0, false));
